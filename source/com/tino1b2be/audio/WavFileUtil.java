...

{
	...
	public static WavFileUtil newWavFile(File file, int numChannels, long numFrames, int validBits, int sampleRate) throws IOException, WavFileException
	{
		// Instantiate new Wavfile and initialise
		WavFileUtil wavFile = new WavFileUtil();
		wavFile.file = file;
	...
	public static WavFileUtil openWavFile(File file) throws IOException, WavFileException
	{
	...
	public boolean isWordAlignAdjust() {
		return wordAlignAdjust;
	}

	public void setWordAlignAdjust(boolean wordAlignAdjust) {
		this.wordAlignAdjust = wordAlignAdjust;
	}
	...
	public static int getFmtChunkId() {
		return FMT_CHUNK_ID;
	}

	public static int getDataChunkId() {
		return DATA_CHUNK_ID;
	}

	public static int getRiffChunkId() {
		return RIFF_CHUNK_ID;
	}

	public static int getRiffTypeId() {
		return RIFF_TYPE_ID;
	}
